...
#include <semantic_octomap_interfaces/msg/ray_rle.hpp>
...
public:
    ...
    virtual bool get_ray_RLE(const octomap::point3d& origin, const octomap::point3d& end,
                             semantic_octomap_interfaces::msg::RayRLE& rayRLE_msg) = 0;
